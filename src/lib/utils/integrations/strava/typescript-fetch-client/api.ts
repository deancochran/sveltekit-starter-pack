...
export const ActivitiesApiFetchParamCreator = function (configuration?: Configuration) {
	return {
		...
		getActivityById(id: number, includeAllEfforts?: boolean, options: unknown = {}): FetchArgs {
			...
			const localVarPath = `/activities/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
			const localVarUrlObj = url.parse(localVarPath, true);
...
export const ActivitiesApiFp = function (configuration?: Configuration) {
	return {
		...
		createActivity(
			...
			const localVarFetchArgs = ActivitiesApiFetchParamCreator(configuration).createActivity(
				name,
				sportType,
				start_date_local,
				elapsedTime,
		...
		getActivityById(
			...
			const localVarFetchArgs = ActivitiesApiFetchParamCreator(configuration).getActivityById(
				id,
				includeAllEfforts,
				options
			);
		...
		getCommentsByActivityId(
			...
			const localVarFetchArgs = ActivitiesApiFetchParamCreator(
				configuration
			).getCommentsByActivityId(id, page, perPage, pageSize, afterCursor, options);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
				return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(
					(response) => {
						if (response.status >= 200 && response.status < 300) {
		...
		getLapsByActivityId(
			...
			const localVarFetchArgs = ActivitiesApiFetchParamCreator(configuration).getLapsByActivityId(
				id,
				options
			);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
		...
		getLoggedInAthleteActivities(
			...
			perPage?: number,
			options?: unknown
		): (fetch?: FetchAPI, basePath?: string) => Promise<Array<SummaryActivity>> {
			const localVarFetchArgs = ActivitiesApiFetchParamCreator(
				configuration
		...
		getZonesByActivityId(
			...
			const localVarFetchArgs = ActivitiesApiFetchParamCreator(configuration).getZonesByActivityId(
				id,
				options
			);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
		...
		updateActivityById(
			...
			const localVarFetchArgs = ActivitiesApiFetchParamCreator(configuration).updateActivityById(
				id,
				body,
				options
			);
...
export class ActivitiesApi extends BaseAPI {
	...
	public getZonesByActivityId(id: number, options?: unknown) {
		return ActivitiesApiFp(this.configuration).getZonesByActivityId(id, options)(
			this.fetch,
			this.basePath
		);
	}
...
export const AthletesApiFp = function (configuration?: Configuration) {
	return {
		...
		getLoggedInAthleteZones(
			...
			const localVarFetchArgs =
				AthletesApiFetchParamCreator(configuration).getLoggedInAthleteZones(options);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
				return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(
					(response) => {
						if (response.status >= 200 && response.status < 300) {
		...
		updateLoggedInAthlete(
			...
			const localVarFetchArgs =
				AthletesApiFetchParamCreator(configuration).updateLoggedInAthlete(options);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
				return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(
					(response) => {
						if (response.status >= 200 && response.status < 300) {
...
export const ClubsApiFetchParamCreator = function (configuration?: Configuration) {
	return {
		...
		getClubById(id: number, options: unknown = {}): FetchArgs {
			...
			const localVarPath = `/clubs/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
			const localVarUrlObj = url.parse(localVarPath, true);
			const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
			const localVarHeaderParameter = {} as unknown;
			const localVarQueryParameter = {} as unknown;
...
export const ClubsApiFp = function (configuration?: Configuration) {
	return {
		...
		getClubActivitiesById(
			...
			const localVarFetchArgs = ClubsApiFetchParamCreator(configuration).getClubActivitiesById(
				id,
				page,
				perPage,
				options
		...
		getClubAdminsById(
			...
			const localVarFetchArgs = ClubsApiFetchParamCreator(configuration).getClubAdminsById(
				id,
				page,
				perPage,
				options
		...
		getClubMembersById(
			...
			const localVarFetchArgs = ClubsApiFetchParamCreator(configuration).getClubMembersById(
				id,
				page,
				perPage,
				options
		...
		getLoggedInAthleteClubs(
			...
			const localVarFetchArgs = ClubsApiFetchParamCreator(configuration).getLoggedInAthleteClubs(
				page,
				perPage,
				options
			);
...
export const GearsApiFetchParamCreator = function (configuration?: Configuration) {
	return {
		...
		getGearById(id: string, options: unknown = {}): FetchArgs {
			...
			const localVarPath = `/gear/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
			const localVarUrlObj = url.parse(localVarPath, true);
			const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
			const localVarHeaderParameter = {} as unknown;
			const localVarQueryParameter = {} as unknown;
...
export const RoutesApiFetchParamCreator = function (configuration?: Configuration) {
	return {
		...
		getRouteById(id: number, options: unknown = {}): FetchArgs {
			...
			const localVarPath = `/routes/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
			const localVarUrlObj = url.parse(localVarPath, true);
			const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
			const localVarHeaderParameter = {} as unknown;
			const localVarQueryParameter = {} as unknown;
...
export const RoutesApiFp = function (configuration?: Configuration) {
	return {
		...
		getRouteAsGPX(
			...
			const localVarFetchArgs = RoutesApiFetchParamCreator(configuration).getRouteAsGPX(
				id,
				options
			);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
		...
		getRouteAsTCX(
			...
			const localVarFetchArgs = RoutesApiFetchParamCreator(configuration).getRouteAsTCX(
				id,
				options
			);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
		...
		getRoutesByAthleteId(
			...
			const localVarFetchArgs = RoutesApiFetchParamCreator(configuration).getRoutesByAthleteId(
				page,
				perPage,
				options
			);
...
export const SegmentEffortsApiFp = function (configuration?: Configuration) {
	return {
		...
		getEffortsBySegmentId(
			...
			perPage?: number,
			options?: unknown
		): (fetch?: FetchAPI, basePath?: string) => Promise<Array<DetailedSegmentEffort>> {
			const localVarFetchArgs = SegmentEffortsApiFetchParamCreator(
				configuration
			).getEffortsBySegmentId(segmentId, start_date_local, endDateLocal, perPage, options);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
				return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(
					(response) => {
						if (response.status >= 200 && response.status < 300) {
...
export class SegmentEffortsApi extends BaseAPI {
	...
	public getSegmentEffortById(id: number, options?: unknown) {
		return SegmentEffortsApiFp(this.configuration).getSegmentEffortById(id, options)(
			this.fetch,
			this.basePath
		);
	}
...
export const SegmentsApiFetchParamCreator = function (configuration?: Configuration) {
	return {
		...
		getSegmentById(id: number, options: unknown = {}): FetchArgs {
			...
			const localVarPath = `/segments/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
			const localVarUrlObj = url.parse(localVarPath, true);
			const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
			const localVarHeaderParameter = {} as unknown;
			const localVarQueryParameter = {} as unknown;
...
export const SegmentsApiFp = function (configuration?: Configuration) {
	return {
		...
		exploreSegments(
			...
			const localVarFetchArgs = SegmentsApiFetchParamCreator(configuration).exploreSegments(
				bounds,
				activityType,
				minCat,
				maxCat,
		...
		getSegmentById(
			...
			const localVarFetchArgs = SegmentsApiFetchParamCreator(configuration).getSegmentById(
				id,
				options
			);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
		...
		starSegment(
			...
			const localVarFetchArgs = SegmentsApiFetchParamCreator(configuration).starSegment(
				id,
				starred,
				options
			);
...
export const StreamsApiFp = function (configuration?: Configuration) {
	return {
		...
		getActivityStreams(
			...
			const localVarFetchArgs = StreamsApiFetchParamCreator(configuration).getActivityStreams(
				id,
				keys,
				keyByType,
				options
		...
		getRouteStreams(
			...
			const localVarFetchArgs = StreamsApiFetchParamCreator(configuration).getRouteStreams(
				id,
				options
			);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
		...
		getSegmentEffortStreams(
			...
			const localVarFetchArgs = StreamsApiFetchParamCreator(configuration).getSegmentEffortStreams(
				id,
				keys,
				keyByType,
				options
		...
		getSegmentStreams(
			...
			const localVarFetchArgs = StreamsApiFetchParamCreator(configuration).getSegmentStreams(
				id,
				keys,
				keyByType,
				options
...
export const UploadsApiFp = function (configuration?: Configuration) {
	return {
		...
		createUpload(
			...
			const localVarFetchArgs = UploadsApiFetchParamCreator(configuration).createUpload(
				file,
				name,
				description,
				trainer,
		...
		getUploadById(
			...
			const localVarFetchArgs = UploadsApiFetchParamCreator(configuration).getUploadById(
				uploadId,
				options
			);
			return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
