...
<AppBar gridColumns="grid-cols-3" slotDefault="place-self-center" slotTrail="place-content-end">
	...
	<svelte:fragment slot="trail">
		<nav class="w-full inline-flex justify-evenly space-x-1">
			...
			{#if session}
				<a class="btn hover:variant-soft-primary" href="/sign-out">Sign-Out</a>
			{:else}
				<a class="btn hover:variant-soft-primary" href="/sign-in">Sign-In</a>
				<a class="btn hover:variant-soft-primary" href="/sign-up">Sign-Up</a>
			{/if}
			<ThemeSelector />
			<a
