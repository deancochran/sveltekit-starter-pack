...
>
	<div class="flex flex-row w-full p-1 space-x-4">
		{#if session}
			<a
				href="/settings"
				class="relative card card-hover w-full p-4 inline-flex flex-row justify-between"
			...
			>
				...
				<div class="relative flex gap-2">
					<Link
						...
						href="/sign-out"
						on:click={() => dispatch('close')}>Sign-Out</Link
					>
				</div>
			</a>
		{:else}
