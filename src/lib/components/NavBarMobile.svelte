...
>
	...
	<div class="flex flex-col items-center justify-center align-middle gap-1">
		...
		{:else}
			<Link label={'Sign In'} href="/sign-in">Sign In</Link>
		{/if}
	</div>

	<div
		class="flex flex-row w-full items-center align-middle justify-end p-4 gap-4 shadow-2xl shadow-surface-900 hide-scrollbar overflow-hidden"
	>
		<LightSwitch />
		<ThemeSelector />
